namespace archiver
{
    public partial class ExtractProgressForm : Form
    {
        ...
        {
            InitializeExtractProgressForm();
        }

        private void InitializeExtractProgressForm()
        {
            // Form settings
        ...
        {
            var result = MessageBox.Show("Are you sure you want to cancel the extraction?",
                "Cancel Extraction", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        public void UpdateProgress(string currentFile, int currentIndex, int totalFiles)
        {
            ...
            // Update status
            lblStatus.Text = $"Extracting file {currentIndex} of {totalFiles}";
