namespace archiver
{
    public partial class ProgressForm : Form
    {
        ...
        {
            var result = MessageBox.Show("Are you sure you want to cancel the compression?", 
                "Cancel Compression", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        public void UpdateProgress(string currentFile, int currentIndex, int totalFiles)
        {
            ...
            // Update status
            lblStatus.Text = $"Compressing file {currentIndex} of {totalFiles}";
        ...
        /// <summary>
        /// Marks the compression as complete
        /// </summary>
